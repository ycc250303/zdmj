    ...
    type Schema = {
      ...
      page: {
        ...
        resumeImport: {
          ...
          careerIncomplete: string;
          projectIncomplete: string;
          skillTypePlaceholder: string;
        ...
        jobs: {
          ...
          careerReport: {
            ...
            generateSuccess: string;
            generateFailed: string;
            gatewayTimeoutFallback: string;
            gatewayTimeoutHint: string;
            polish: string;
            polishing: string;
            ...
            userPreferenceLabel: string;
            userPreferencePlaceholder: string;
            focusLabel: string;
            focusPlaceholder: string;
            polishInstructionLabel: string;
            polishInstructionPlaceholder: string;
