const local: App.I18n.Schema = {
  ...
  page: {
    ...
    resume: {
      ...
      "confirmDeleteCareer": "Are you sure you want to delete this career record?",
    ...
    resumeImport: {
      title: 'My Resume',
      subtitle: 'Upload PDF to parse and overwrite current resume',
      edit: 'Edit',
      save: 'Save',
      cancelEdit: 'Cancel',
      editHint: 'Click "Save" to submit; "Cancel" to discard',
      saveSuccess: 'Resume saved',
      saveFail: 'Save failed',
      applyFail: 'Import failed',
      applySuccess: 'Resume imported',
      skillRequired: 'Please fill in at least one skill item',
      educationIncomplete: 'Please complete education required fields',
      careerIncomplete: 'Please complete career required fields',
      projectIncomplete: 'Please complete project required fields',
      awardIncomplete: 'Please complete award required fields',
      skillTypePlaceholder: 'Skill category',
      addSkillGroup: 'Add Skill Category',
      uploadSection: 'PDF Recognition',
      uploadPdf: 'Upload PDF',
      parsing: 'Parsing...',
      uploadTip: 'Supports text-based PDF resumes',
      uploadFail: 'Upload failed',
      parseFail: 'Parse failed',
      parseSuccess: 'Parse complete',
