const local: App.I18n.Schema = {
  ...
  page: {
    ...
    chat: {
      ...
      knowledgePanelDesc: 'Choose retrieval scope before the first message; it is locked after the chat starts',
      knowledgeConfigFrozen: 'This chat has started. Knowledge selection is locked; start a new chat to change it.',
    ...
    "profile": {
      ...
      basicInfo: {
        ...
        preferredWorkCityPlaceholder: "e.g. Beijing, Shanghai",
    ...
    resume: {
          ...
          "skillTip": "Manage specific skill items in 'My Resume'. This section provides an overall layout preview.",
          ...
          "alertSkillTip": "Note: After creation, you can edit skill stacks (Vue, React, etc.) in 'My Resume'.",
          ...
          "confirmDeleteAward": "Are you sure you want to delete this award record?",
          ...
          "awardTypeScholarship": "Scholarship",
          "awardTypeCompetition": "Competition",
    ...
    resumeImport: {
      title: 'My Resume',
      subtitle: 'Upload PDF to parse and overwrite your resume; view and edit here',
      defaultResumeName: 'My Resume',
      edit: 'Edit',
      save: 'Save',
      cancelEdit: 'Cancel',
      editHint: 'Click Save to submit changes; Cancel discards unsaved edits',
      saveSuccess: 'Resume saved',
      saveFail: 'Save failed. Please check required fields',
      applyFail: 'Import failed. Please try again',
      skillRequired: 'Please add at least one skill entry',
      educationIncomplete: 'Complete required education fields or remove empty entries',
      careerIncomplete: 'Complete required experience fields or remove empty entries',
      projectIncomplete: 'Complete required project fields or remove empty entries',
      awardIncomplete: 'Complete required award fields or remove empty entries',
      skillTypePlaceholder: 'Category, e.g. Programming Languages',
      addSkillGroup: 'Add skill category',
      nameRequired: 'Resume name is required',
      renamePlaceholder: 'Resume name',
      uploadSection: 'PDF Recognition',
      uploadPdf: 'Upload PDF Resume',
      parsing: 'Parsing…',
      uploadTip: 'Text-based PDF recommended. Successful import overwrites your current resume.',
      uploadFail: 'Upload failed',
      parseFail: 'Resume parsing failed',
      parseSuccess: 'Parsing complete, please preview',
      pdfOnly: 'PDF files only',
      noSection: 'No content',
      previewTitle: 'Parse Preview',
      previewHint: 'Data will be written to your resume after confirmation',
      applyToResume: 'Confirm Import',
      applySuccess: 'Import successful, resume overwritten',
      createResumeFail: 'Failed to load resume',
      loadFail: 'Failed to load resume. Please refresh and try again.'
    },
    knowledge: {
    ...
    jobs: {
      ...
      missingSkills: "Additional Typical Requirements",
      summary: "Summary",
      ...
      careerGraph: {
        entry: "Career Graph",
        generate: "Generate Career Graph",
        regenerate: "Regenerate Graph",
        view: "View Career Graph",
        drawerTitle: "Job Career Graph",
        empty: "No career graph yet. Click to generate.",
        generating: "Generating career graph, this may take 30-60 seconds…",
        generateSuccess: "Career graph generated",
        generateFailed: "Failed to generate career graph",
        gatewayTimeoutFallback: "Gateway dropped the request (504); polling latest version…",
        gatewayTimeoutHint: "Gateway timeout (504). Refresh the page later to check if generation completed.",
        targetRoleType: "Role Type",
        currentNode: "Current Role",
        verticalPath: "Vertical Career Path",
        ...
        difficultyHard: "Hard",
        reason: "Reason",
        bridgingSkills: "Bridging Skills",
