const local: App.I18n.Schema = {
  ...
  page: {
    ...
    resumeImport: {
      title: 'Resume Import',
      subtitle: 'Create an empty resume first, then upload PDF to parse and import',
      defaultResumeName: 'New Resume',
      createResume: 'New Resume',
      createSuccess: 'Empty resume created',
      rename: 'Rename',
      renamePlaceholder: 'Resume name',
      renameSuccess: 'Resume name updated',
      renameFail: 'Rename failed',
      nameRequired: 'Resume name is required',
      uploadSection: 'PDF Recognition',
      uploadPdf: 'Upload PDF Resume',
      parsing: 'Parsing…',
      uploadTip: 'Text-based PDF recommended. Data will apply to the selected resume.',
      uploadNeedResume: 'Create or select a resume before uploading',
      uploadFail: 'Upload failed',
      parseFail: 'Resume parsing failed',
      parseSuccess: 'Parsing complete, please preview',
      pdfOnly: 'PDF files only',
      resumeList: 'My Resumes',
      emptyList: 'No resume yet. Create an empty one first.',
      sectionCounts: 'Edu / Career / Project',
      selectOrCreateHint: 'Create or select a resume on the left',
      aggregated: 'Aggregated View',
      noSection: 'No content',
      previewTitle: 'Parse Preview',
      previewHint: 'Data will be written to the selected resume after confirmation',
      applyToResume: 'Apply to Current Resume',
      applySuccess: 'Import successful',
      createResumeFail: 'Failed to create resume'
    },
    knowledge: {
