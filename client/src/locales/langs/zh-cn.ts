const local: App.I18n.Schema = {
  ...
  page: {
    ...
    chat: {
      ...
      knowledgePanelDesc: '发送首条消息前可勾选检索范围，开始对话后锁定',
      knowledgeConfigFrozen: '已开始对话，知识库已锁定；更换请开新对话',
    ...
    profile: {
      ...
      basicInfo: {
        ...
        preferredWorkCity: '意向工作城市',
        preferredWorkCityPlaceholder: '例如：北京、上海',
    ...
    resume: {
      ...
      "skillTip": "专业技能的具体细项请在「我的简历」中增删，此处支持总体排版预览。",
      ...
      "alertSkillTip": "注：创建后您可以在「我的简历」中详细编辑具体的技能栈（Vue, React等）。",
    ...
    resumeImport: {
      ...
      nameRequired: '简历名称不能为空',
      renamePlaceholder: '请输入简历名称',
      ...
      noSection: '暂无内容',
      previewTitle: '识别结果预览',
      previewHint: '确认后将写入简历关联的经历数据',
      applyToResume: '确认导入',
      applySuccess: '识别成功，已覆盖当前简历',
      createResumeFail: '简历加载失败',
      loadFail: '简历加载失败，请刷新页面重试'
    },
    jobs: {
      title: "岗位信息",
      create: "创建岗位",
      ...
      careerGraph: {
        ...
        view: "查看关联图谱",
        drawerTitle: "岗位关联图谱",
        empty: "暂无岗位关联图谱，点击右上角生成",
        generating: "正在生成岗位关联图谱，预计需要 30 秒~1 分钟…",
        generateSuccess: "生成岗位关联图谱成功",
        generateFailed: "生成岗位关联图谱失败",
        gatewayTimeoutFallback: "请求被网关掐断（504），后端可能仍在生成，正在尝试拉取最新版本…",
        gatewayTimeoutHint: "网关超时（504），请稍后刷新页面查看是否已生成完成",
        targetRoleType: "岗位类型",
        currentNode: "当前岗位",
        verticalPath: "垂直晋升路径",
        transitionPaths: "换岗路径图谱",
        typicalYears: "典型年限",
        responsibilities: "核心职责",
        keyRequirements: "关键能力",
        targetRole: "目标岗位",
        difficulty: "转岗难度",
        difficultyEasy: "较易",
        difficultyMedium: "中等",
