const local: App.I18n.Schema = {
  ...
  page: {
    ...
    resumeImport: {
      title: '我的简历',
      subtitle: '先新建简历并写入库，选中后再上传 PDF 识别并导入',
      defaultResumeName: '新简历',
      createResume: '新建简历',
      createSuccess: '已创建空简历',
      rename: '重命名',
      renamePlaceholder: '请输入简历名称',
      renameSuccess: '简历名称已更新',
      renameFail: '重命名失败',
      nameRequired: '简历名称不能为空',
      uploadSection: 'PDF 识别',
      uploadPdf: '上传 PDF 简历',
      parsing: '识别中…',
      uploadTip: '支持 PDF 文字版简历，识别后请预览并确认写入当前选中简历',
      uploadNeedResume: '请先新建或选择一份简历后再上传',
      uploadFail: '文件上传失败',
      parseFail: '简历识别失败，请稍后重试',
      parseSuccess: '识别完成，请预览确认',
      pdfOnly: '仅支持 PDF 文件',
      resumeList: '我的简历',
      emptyList: '暂无简历，请先新建一份空简历',
      sectionCounts: '教育/实习/项目',
      selectOrCreateHint: '请先新建或选择左侧的一份简历',
      aggregated: '聚合视图',
      noSection: '暂无内容',
      previewTitle: '识别结果预览',
      previewHint: '确认后将写入当前选中简历关联的经历数据',
      applyToResume: '确认导入到当前简历',
      applySuccess: '导入成功，已刷新简历内容',
      createResumeFail: '创建简历失败'
    },
    jobs: {
      title: "岗位信息",
      create: "创建岗位",
